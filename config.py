...
ENRICH_EVENT_WITH_PULSE_NAMES = False       # if ENRICH_EVENT_WITH_PULSE_NAMES is set to True, the pulse names that an indicator exists in will be written into the attribute comment
